# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-11 08:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geschlecht', models.CharField(choices=[('weiblich', 'w'), ('männlich', 'm'), ('sonstiges', '')], default='m', max_length=1)),
                ('tel', models.CharField(blank=True, max_length=20, null=True)),
                ('strasse', models.CharField(blank=True, max_length=30)),
                ('plz', models.CharField(blank=True, max_length=5, validators=[django.core.validators.RegexValidator('^[0-9]+$')])),
                ('ort', models.CharField(blank=True, max_length=30)),
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='my_profile', to=settings.AUTH_USER_MODEL, verbose_name='Nutzer'),
        ),
    ]
